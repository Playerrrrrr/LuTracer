...
namespace LuTracer {
	...
	struct core_para {
		...
		__host__ __device__ static constexpr const unsigned int IMAGE_WIDTH() { return 1280; };
		__host__ __device__ static constexpr const unsigned int IMAGE_HEIGHT() { return 720; };
